        ...
        <div class="sectionContentmiddle">
            <div class="sectionTitle" style="width:100%; clear:both;">
                ...
                <ul class="sectionSubmenu">
                    <li style="display:none;">See all:</li>
                    <li style="display:none;"><a class="ajaxSend">Series</a></li>
                    <li class="sectionSubmenuButton" style="display:none;"><a class="ajaxSend" href="/send_tracks">Upload song</a></li>
                </ul>
            </div>  
        </div>
