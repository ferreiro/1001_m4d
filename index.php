        ...
        <div class="sectionContentRight">
            ...
            <div class="SectionToptracks">
                ...
                <?php
                    ...
                    wpp_get_mostpopular( "range=weekly&limit=8&freshness=1&order_by=views&title_length=8&title_by_words=1&thumbnail_width=40&thumbnail_height=40&stats_views=0&post_html=\"<li>{thumb} <a href='{url}'>{text_title}</a> </li>\"" );
                ?>
                </div>
                ...
                <?php
                    $categories = get_the_category();
                    $category_id = $categories[0]->cat_ID;
                    wpp_get_mostpopular( "range=monthly&limit=8&freshness=1&order_by=views&title_length=8&title_by_words=1&thumbnail_width=40&thumbnail_height=40&stats_views=0&post_html=\"<li>{thumb} <a href='{url}'>{text_title}</a> </li>\"" );
                ?>
                </div>
                ...
                <?php
                    $categories = get_the_category();
                    $category_id = $categories[0]->cat_ID;
                    wpp_get_mostpopular( "range=all&limit=8&freshness=1&order_by=views&title_length=8&title_by_words=1&thumbnail_width=40&thumbnail_height=40&stats_views=0&post_html=\"<li>{thumb} <a href='{url}'>{text_title}</a> </li>\"" );
                ?>
                </div>
